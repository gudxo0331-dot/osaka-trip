(()=>{
  ...
  const G={
    ...
    'c>w':{
      ...
      note:'주유패스 이용을 위해 Osaka Metro 경로 선택. Google Maps가 JR을 추천하면 별도 요금이므로 노선을 확인. 전망대는 14:00 입장 목표.'
    },
    'j>c':{
      ...
      note:'11:00은 예상 도착 시각. 매표·이동이 늦어지면 성 관람을 줄여 전망대 입장 시간을 지키기.'
    },
    'm>h':{
      diff:'주유패스 · 지하철 직통',path:'오사카역 주변 → 미도스지선 우메다 M16 → 난바 M20 → 호텔',
      ...
      note:'16:30은 우메다 출발 시각. 호텔 도착 후 잠깐 쉬고 18:00 저녁으로 이어가기.'
    },
    'm>d':{
